...
logo = '\x1b[1;97m\n\x1b[1;93mVipro   : \x1b[1;96mv7.8/BlackCoder\x1b[1;97m\n\x1b[1;93mAuthor  : DIcky CaNdRA\x1b[1;97m\x1b[1;96m\x1b[1;97m \x1b[1;97m\n\x1b[1;93mSupport : \x1b[1;91mVolta|Edi|PutraDicko \n'
print '\x1b[1;96m                   /\  /--\  '                
...
print '\x1b[1;96m   *BLACK CODER*   \    /   '
print '\x1b[1;96m  \ Crack Facebook\  \  /    '
print '\x1b[1;96m  /Author: DIcky CaNdRA\/     ' 

os.system("figlet MacroCrush |lolcat")
...
def login():
    os.system('clear')
    os.system("figlet DarkGray Coder |lolcat")
    try:
        ...
        print '\x1b[1;96m================ \x1b[1;92mLOGIN FACEBOOK \x1b[1;96m==============='
        print '\x1b[1;97m\n\x1b[1;93m*] Silahkan Login Operamini Agar Tidak Checkpoint'
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://api.whatsapp.com/send?phone=62881026885233')
                time.sleep(2)
                menu()
...
def menu():
    ...
    print '\x1b[1;96m     /\/\/\/\/\ /         \  ' 
    print '\x1b[1;96m    /_______________      /  ' 
    print '\x1b[1;96m   *DarkGray*   Coder\    /   '
    print '\x1b[1;96m  \ Crack \  \  /    '
    print '\x1b[1;96m  /Author:DIcky CaNdRA\/     ' 
    print logo
...
def pilih():
    zedd = raw_input('\x1b[1;96mroot@Dizart-y ')
    if zedd == '':
